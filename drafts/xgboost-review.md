...
*September 10, 2025 · Machine Learning · **DRAFT***

## 1. What is XGBoost

XGBoost is the combination of weak sequential tree learner. Where the following tree will fix the previous mistakes. XGBoost is ensemble tree model same as Random Forest. But the key difference is that RF uses combination of strong tree learner where XGBoost is exactly the opposite.
...
Learn about interpretable machine learning by xgboost as well: [Interpretable Machine Learning with XGBoost](https://medium.com/data-science/interpretable-machine-learning-with-xgboost-9ec80d148d27)
